...
class RearRightUltrasonicSubscriber(object):
    ...
    def __init__(self, robot_host):
        ...
        self.sub = rospy.Subscriber(self.robot_host + '/ultrasonic/rear/right/distance', Range, self.callback)
    ...
    def callback(self, data):
        ...
        plt.title('REAR RIGHT ULTRASONIC SENSOR - ENVIRONMENT MAP', fontname='monospace', color='black', fontsize=16)
...
if __name__ == '__main__':
    ...
    node_name = re.sub("-", "_", socket.gethostname()) + "_RearRightUltrasonicSubscriber"
    rospy.init_node(node_name, anonymous=False)
    
    ultrasonic = RearRightUltrasonicSubscriber("robotcar")
