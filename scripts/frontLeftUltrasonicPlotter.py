...
class FrontLeftUltrasonicSubscriber(object):
    ...
    def __init__(self, robot_host):
        ...
        self.sub = rospy.Subscriber(self.robot_host + '/ultrasonic/front/left/distance', Range, self.callback)
    ...
    def callback(self, data):
        ...
        plt.title('FRONT LEFT ULTRASONIC SENSOR - ENVIRONMENT MAP', fontname='monospace', color='black', fontsize=16)
...
if __name__ == '__main__':
    ...
    node_name = re.sub("-", "_", socket.gethostname()) + "_FrontLeftUltrasonicSubscriber"
    rospy.init_node(node_name, anonymous=False)
    
    ultrasonic = FrontLeftUltrasonicSubscriber("robotcar")
