...
class OrientationCurvesPlotter(object):
    ...
    def __init__(self, robot_host):
        ...
        self.sub = rospy.Subscriber(self.robot_host + '/imu/orientation/raw', orientation, self.callback)
...
if __name__ == '__main__':
    ...
    node_name = re.sub("-", "_", socket.gethostname()) + "_OrientationCurvesPlotter"
    rospy.init_node(node_name, anonymous=False)
    
    orientation = OrientationCurvesPlotter("robotcar")
