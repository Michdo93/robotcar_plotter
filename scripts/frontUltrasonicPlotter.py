...
class FrontUltrasonicPlotter(object):
    ...
    def __init__(self, robot_host):
        ...
        self.sub = rospy.Subscriber(self.robot_host + '/ultrasonic/front/distance', Range, self.callback)
    ...
    def callback(self, data):
        ...
        plt.title('FRONT ULTRASONIC SENSOR - ENVIRONMENT MAP', fontname='monospace', color='black', fontsize=16)
