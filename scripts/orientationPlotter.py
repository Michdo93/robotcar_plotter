...
class OrientationPlotter(object):
    ...
    def __init__(self, robot_host):
        ...
        self.sub = rospy.Subscriber(self.robot_host + '/imu/orientation', orientation, self.callback)
...
if __name__ == '__main__':
    ...
    node_name = re.sub("-", "_", socket.gethostname()) + "_OrientationPlotter"
    rospy.init_node(node_name, anonymous=False)
    
    orientation = OrientationPlotter("robotcar")
