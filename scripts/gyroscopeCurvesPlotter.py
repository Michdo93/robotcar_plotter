...
class GyroscopeCurvesPlotter(object):
    ...
    def __init__(self, robot_host):
        ...
        self.sub = rospy.Subscriber(self.robot_host + '/imu/gyroscope/raw', Gyroscope, self.callback)
...
if __name__ == '__main__':
    ...
    node_name = re.sub("-", "_", socket.gethostname()) + "_GyroscopeCurvesPlotter"
    rospy.init_node(node_name, anonymous=False)
    
    gyroscope = GyroscopeCurvesPlotter("robotcar")
