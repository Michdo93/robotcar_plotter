...
class RearUltrasonicSubscriber(object):
    ...
    def __init__(self, robot_host):
        ...
        self.sub = rospy.Subscriber(self.robot_host + '/ultrasonic/rear/distance', Range, self.callback)
    ...
    def callback(self, data):
        ...
        plt.title('REAR ULTRASONIC SENSOR - ENVIRONMENT MAP', fontname='monospace', color='black', fontsize=16)
...
if __name__ == '__main__':
    ...
    node_name = re.sub("-", "_", socket.gethostname()) + "_RearUltrasonicSubscriber"
    rospy.init_node(node_name, anonymous=False)
    
    ultrasonic = RearUltrasonicSubscriber("robotcar")
