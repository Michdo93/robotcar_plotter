...
class RearLeftUltrasonicPlotter(object):
    ...
    def __init__(self, robot_host):
        ...
        self.sub = rospy.Subscriber(self.robot_host + '/ultrasonic/rear/left/distance', Range, self.callback)
    ...
    def callback(self, data):
        ...
        plt.title('REAR LEFT ULTRASONIC SENSOR - ENVIRONMENT MAP', fontname='monospace', color='black', fontsize=16)
